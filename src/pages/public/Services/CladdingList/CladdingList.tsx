...
const featuredCladdings : FeaturedCladding[] = [
  {
    id: 1,
    name: "Composite",
...
const seo : SeoData = {
    ...
    description:
        "Explore premium composite, wood, and PVC cladding solutions for ceilings, walls, pergolas, columns, and outdoor living spaces throughout South Florida.",
